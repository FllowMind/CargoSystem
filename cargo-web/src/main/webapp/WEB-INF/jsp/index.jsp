...
<head>
    ...
    <link rel="stylesheet" href="/style/flightDynamics.css">
    <!-- endbuild -->
</head>
...
<body ng-app="OMS">
    ...
    <div id="Wrapper" ng-controller="fileDynamicCtrl">
        <header id="Header">
            ...
            <div class="nav">
                <ul>
                    <li><a id="FlightDynamics" class="active" href="flightDynamics.html">航班动态</a></li>
                    <li><a id="SpeedExplain" href="schedule.html">进度分解</a></li>
