package com.itran.cargosystem.dao;
...
public interface CommonDao {
	 ...
	 * @throws Exception
	 */
	<T> T selectByPrimaryKey(Class<T> clazz, Serializable pk) throws Exception;
	 ...
	 * @throws Exception
	 */
	/*<T> int insertExceptPk(T t) throws Exception;*/
	 ...
	 * @return 数据条数
	 */
	<T> int deleteByPrimaryKey(Class<T> clazz, Serializable pk);
