...
public class TypeCastUtil {
	...
	public static Number castToNumber(Object value) throws Exception {
		...
		throw new Exception(value + " : value is not Number type or Boolean type, can not castToNumber");
	}
	...
	public static Boolean castToBoolean(Object value) throws Exception {
		...
		throw new Exception(value + " : value is not Number type or Boolean type, can not castToBoolean");
	}
